...
const services: Array<{
...
}> = [
  {
    ...
    description: "Mechanically refined, densified, and guarded for showrooms, retail, offices, and hospitality floors.",
    suited: "Showrooms, retail, hospitality",
    spec: "Cream to full exposure",
    image: FLOOR_IMAGES.interior,
  },
  {
    slug: "honed",
    title: "Honed concrete",
    description: "Matte commercial finishes with aggregate character, low glare, and practical slip-aware texture.",
    suited: "Cafes, entries, courtyards",
  ...
  },
  {
    ...
    suited: "Warehouses, kitchens, plant rooms",
